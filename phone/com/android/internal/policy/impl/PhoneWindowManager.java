...
public class PhoneWindowManager implements WindowManagerPolicy {
        ...
        if (attrs != null) {
            ...
            if (down) {
                if (!keyguardOn) {
                    ...
                    String appUri = Settings.System.getString(mContext.getContentResolver(), property);
                    if (appUri != null) {
                        try {
    ...
    /*
     * mtwebster -
     * Added functions for allowing adjustable haptic feedback in certain global areas of phone
     */
    ...
    private long[] loadHaptic(int hapType){
        switch (hapType) {
            case HapticFeedbackConstants.VIRTUAL_KEY :
                ...
                hapString = Settings.System.getString(mContext.getContentResolver(),Settings.System.HAPTIC_DOWN_ARRAY);
                hapDefault = getLongIntArray(mContext.getResources(),
                        com.android.internal.R.array.config_virtualKeyVibePattern);
                Log.i(TAG, "pulled string: "+hapString+" default: "+ longArrayToString(hapDefault));
                if (hapString != null) {
            ...
            case HapticFeedbackConstants.VIRTUAL_RELEASED :
                ...
                hapString = Settings.System.getString(mContext.getContentResolver(),Settings.System.HAPTIC_UP_ARRAY);
                hapDefault = getLongIntArray(mContext.getResources(),
            ...
            case HapticFeedbackConstants.LONG_PRESS :
                ...
                hapString = Settings.System.getString(mContext.getContentResolver(),Settings.System.HAPTIC_LONG_ARRAY);
                hapDefault = getLongIntArray(mContext.getResources(),
            ...
            case HapticFeedbackConstants.KEYBOARD_TAP :
                ...
                hapString = Settings.System.getString(mContext.getContentResolver(),Settings.System.HAPTIC_TAP_ARRAY);
                hapDefault = getLongIntArray(mContext.getResources(),
    ...
    /**
     * saveHapticToSettings should only be run on first boot of system - 
     * it saves the config.xml values to system settings, in both 'current' settings
     * and 'default' settings - so the user can always go back to stock
